    ...
    <dialog id="donatemodal" class="lmt-dialog" aria-labelledby="donatemodal-title">
        <div class="lmt-dialog-content modal-content tw:text-center">
            <h2 id="donatemodal-title" class="tw:pb-6">Support us ☕
                <button type="button" class="lmt-dialog-close tw:pt-1" aria-label="Close">
            ...
            <div class="donate-box">
                <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=ADUSQ5WWUPQXQ&item_name=Lamixtape&currency_code=EUR&source=url" class="btn btn-donate tw:mt-6 tw:mb-4" target="_blank">Donate via PayPal</a><br>
    ...
    <dialog id="contactmodal" class="lmt-dialog" aria-labelledby="contactmodal-title">
        <div class="lmt-dialog-content modal-content tw:text-center">
            <h2 id="contactmodal-title" class="tw:pb-6">Contact us 💌
                <button type="button" class="lmt-dialog-close tw:pt-1" aria-label="Close">
                    <span aria-hidden="true"><svg class="bi bi-x" width="40" height="40" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708-.708l7-7a.5.5 0 0 1 .708 0z"/>
                        <path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708l-7-7a.5.5 0 0 0-.708 0z"/>
            ...
            <p class="tw:mb-6">Your feedback helps us, we read each message and reply personally.</p>
