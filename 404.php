...
<div class="container mx-auto px-4">
    ...
    <section class="text-right font-smoothing pb-12">
        ...
        <a class="inline-flex items-center bg-transparent text-white border-2 border-current rounded-none px-5 py-2.5 text-lg uppercase" href="<?php echo esc_url( rest_url( 'lamixtape/v1/random-mixtape' ) ); ?>">
            <svg aria-hidden="true" focusable="false" class="bi bi-shuffle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg> <?php esc_html_e('Random Mixtape', 'lamixtape'); ?>
        </a>
    </section>
