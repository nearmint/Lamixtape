	  ...
	  <div class="container mx-auto px-4">
	  	<div class="flex flex-wrap footer-player-container items-center">
            ...
            <img id="yt-thumb" src="" alt="Track thumbnail" style="width:40px;height:40px;object-fit:cover;border-radius:4px;" loading="lazy" decoding="async">
	  		...
	  		<div class="flex-1 px-4 flex flex-row items-center">
        ...
        <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308
	  		...
	  		<div class="w-1/6 px-4 hidden sm:block">
	  			<button id="discogs-search" class="btn-discogs inline-flex items-center gap-1 border border-white text-white bg-transparent px-2 py-1 cursor-pointer uppercase" style="display: none;">
            Search on Discogs
