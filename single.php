...
?>
<article class="mixtape font-smoothing pb-12" data-color="<?php echo esc_attr( $bg_color ); ?>" style="background-color:<?php echo esc_attr( $bg_color ); ?>; color:<?php echo esc_attr( $fg_color ); ?>;">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap pt-6 lg:pt-12">
            ...
            <div class="hidden lg:block lg:w-1/3 text-right buttons">
                <button class="like__btn like-btn" aria-label="<?php esc_attr_e( 'Like this mixtape', 'lamixtape' ); ?>">
